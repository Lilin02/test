					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
								<INPUT class=textbox 
														style="WIDTH: 180px" maxLength=50 name="visit_time" id="visitTime" readonly="readonly">
								</td>
								<td>拜访地点 ：</td>
								<td>
								...
								<td>
								<INPUT class=textbox 
														style="WIDTH: 180px" maxLength=50 name="visit_nexttime" id="visitNexttime" readonly="readonly">
								</td>
							</TR>
							<TR>
								<td>拜访详情 ：</td>
								<td>
								<textarea rows="5" cols="25"  name="visit_detail"></textarea>
								</td>
