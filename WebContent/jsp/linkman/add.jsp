...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkman_savelinkman.action"
		method=post>
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<TD>所属客户：</TD>
								<TD><select name="customer.cust_id" id="customerId" style="WIDTH: 182px;height:20px"></select></TD>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td>
